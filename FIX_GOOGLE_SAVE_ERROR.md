...
1. Click the **X** next to `https://certimint.preview.emergentagent.com` to remove it
2. Keep only these 2:
   - `https://ewtwjfwobqkivrpicvvl.supabase.co`
   - `http://localhost:3000`
3. Click **Save**
...
1. Edit OAuth client again
2. Add: `https://certimint.preview.emergentagent.com`
3. Click **Save**
...
1. **Click the X** next to `https://certimint.preview.emergentagent.com`
