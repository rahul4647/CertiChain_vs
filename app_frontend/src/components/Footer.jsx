...
import { Award, Twitter, Github, Linkedin } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold">CertiChain</span>
            </div>
            <p className="text-slate-400 text-sm">
              Blockchain-powered digital certificates for the modern world.
            </p>
          </div>
